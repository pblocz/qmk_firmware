...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_CTRL_TAB] = ACTION_TAP_DANCE_DOUBLE(KC_LCTRL, KC_LGUI)
};
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt |  DEL |LOWER | /Space  /       \Enter \  |RAISE |BackSP| LCTRL |
 *                   |      |      |      |/       /         \      \ |      |      | /LGUI |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                        KC_LALT, KC_DEL, MO(_LOWER), KC_SPC, KC_ENT, MO(_RAISE), KC_BSPC, TD(TD_CTRL_TAB) \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
